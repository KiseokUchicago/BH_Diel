...
write.table(combined_tsv_pepid,"Replicate_ABC63_combined.tsv", sep='\t',row.names = F)
openxlsx::write.xlsx(combined_tsv_pepid,'Replicate_ABC63_combined.xlsx',rowNames=F)
