...
directory_path = "data/diel-Feb26"
list_f <- list.files(path="data/diel-Feb26")
length(list_f)
...
write.table(combined_tsv_pepid,"Replicate_ABC50_combined.tsv", sep='\t',row.names = F)
openxlsx::write.xlsx(combined_tsv_pepid,'Replicate_ABC50_combined.xlsx',rowNames=F)
